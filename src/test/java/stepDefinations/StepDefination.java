...
public class StepDefination extends Utils{
	...
	/*
	 * @Given("Add place Payload") public void add_place_api_payload() throws
	 * IOException {
	 * 
	...
	@Then("API call got success and status code is {int}")
	public void api_call_got_success_and_status_code_is(Integer int1) {
